...
-- @release_key - table or string
function _M.switch(dir, mod_key1, release_key, mod_key2, key_switch)
  -- Preprocess release_keys (maybe user wants to press not one key for release)
  local release_klist = type(release_key) == "table" and release_key or { release_key }
  _M.populateAltTabTable()
